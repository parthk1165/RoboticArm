...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    ...
    <h1 style="color: teal;text-align:center;">Project Group 35</h1>
    <h2 style="color: teal;text-align:center;">Robotic Arm Control</h2>
...
void playRecordedRobotArmSteps()
{
  ...
  delay(1000); // Delay before starting the actual steps.
...
void loop() 
{
  ...
  { 
    if(ultradistance){
      Serial.println("if_BOOL:ultradistance : ");
      Serial.print(ultradistance);
